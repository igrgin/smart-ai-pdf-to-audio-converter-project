...
public class AudiobookConversionExceptionHandler {
    ...
    ProblemDetail invalidCommand() {
        ProblemDetail problem =
                ProblemDetail.forStatusAndDetail(
                        HttpStatus.BAD_REQUEST, "The Audiobook Conversion command is invalid.");
    ...
    ProblemDetail conflictingCommand() {
        ProblemDetail problem =
                ProblemDetail.forStatusAndDetail(
                        HttpStatus.CONFLICT,
                        "The Audiobook Conversion changed or cannot accept this command in its"
                                + " current state.");
    ...
    ProblemDetail unavailable() {
        ProblemDetail problem =
                ProblemDetail.forStatusAndDetail(
                        HttpStatus.NOT_FOUND, "The Audiobook Conversion is unavailable.");
