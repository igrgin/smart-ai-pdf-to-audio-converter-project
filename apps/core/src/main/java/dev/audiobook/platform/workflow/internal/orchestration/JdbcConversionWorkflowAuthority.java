...
class JdbcConversionWorkflowAuthority {
    ...
    private boolean prerequisiteAccepted(UUID conversionId, Stage stage) {
        Stage prerequisite = switch (stage) {
    ...
    private long reusableCharacters(UUID listenerId, UUID conversionId) {
        Long reusable = jdbcTemplate.queryForObject(
                """
    ...
    private record CancellationOperation(
        ...
        boolean matchesListener(UUID listenerId, UUID conversionId, long expectedConversionVersion) {
