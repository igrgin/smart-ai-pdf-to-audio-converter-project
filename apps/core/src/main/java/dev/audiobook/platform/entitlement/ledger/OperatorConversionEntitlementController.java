...
import dev.audiobook.platform.entitlement.ledger.service.*;
...
public class OperatorConversionEntitlementController {
    ...
    public ResponseEntity<FreeGrantView> approveFreeGrant(
        ...
        ConversionEntitlementService.FreeGrant grant =
    ...
    public ResponseEntity<ProviderSpendView> providerSpend(@PathVariable String provider) {
        ConversionEntitlementService.ProviderSpend spend =
                entitlementService.providerSpend(provider);
        return ResponseEntity.ok()
                .cacheControl(CacheControl.noStore())
                .body(
                        new ProviderSpendView(
                                provider, spend.reservedMicros(), spend.committedMicros()));
    }
