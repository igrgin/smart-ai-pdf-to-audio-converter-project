...
import dev.audiobook.platform.trustoperations.service.TrustOperationsService.DelegatedAccessGrant;
...
public class DelegatedAccessRequestWorkflow {
    ...
    @Transactional
    public PendingAccessRequest request(
            StaffContext staff,
            UUID caseId,
            String purposeCode,
        ...
        return new PendingAccessRequest(
                ...
                context.opaqueResourceReference(),
                context.resourceKind(),
                context.restrictionCode(),
                context.consequenceCode(),
                context.deadline(),
                purposeCode,
                allowedActions,
                expiresAt,
    ...
    @Transactional
    public DelegatedAccessGrant approve(UUID listenerId, UUID requestId, String operationKey) {
        ...
        List<String> decisions =
                jdbcTemplate.queryForList(
                        "SELECT operation_key FROM"
                            + " trust_operations.delegated_access_request_decision WHERE request_id"
                            + " = ?",
                        String.class,
                        requestId);
        ...
        DelegatedAccessGrant grant =
                trustOperationsService.approveDelegatedAccess(
    ...
    public List<PendingAccessRequest> pending(UUID listenerId) {
    ...
    private PendingAccessRequest find(UUID requestId) {
        List<PendingAccessRequest> rows =
                jdbcTemplate.query(
    ...
    private static PendingAccessRequest pending(java.sql.ResultSet resultSet)
    ...
    public record PendingAccessRequest(
            UUID requestId,
            UUID caseId,
            @com.fasterxml.jackson.annotation.JsonIgnore UUID listenerId,
            UUID staffId,
