...
public final class SessionLifecycleFilter extends OncePerRequestFilter {

    public static final String LAST_ROTATION =
            SessionLifecycleFilter.class.getName() + ".lastRotation";
    ...
    protected void doFilterInternal(
        ...
        if (session != null && SecurityContextHolder.getContext().getAuthentication() != null) {
            ...
            long rotationTime =
                    lastRotation instanceof Long value ? value : session.getCreationTime();
