...
INSERT INTO narration.narrator_voice (
    ...
    ('10000000-0000-7000-8000-000000000004', 4, 'Callum', 'British English',
     'Calm', 'Intimate', 'voice-review-2026-07', 'AVAILABLE',
     '/samples/narrator-voices/callum-folio-preview-v1.mp3', 'folio-preview-v1', 29, TRUE),
...
INSERT INTO narration.provider_capability_profile (
    ...
    'https://eu.api.openai.com/v1/audio/speech', 'gpt-4o-mini-tts-2025-12-15', 'eu',
...
INSERT INTO narration.voice_mapping (
    ...
    ('30000000-0000-7000-8000-000000000001', '10000000-0000-7000-8000-000000000001', '20000000-0000-7000-8000-000000000001', 'rowan-openai-v1', 'cedar',
     '{"MEASURED":{"speed":0.88,"instructions":"Measured, warm and grounded audiobook narration."},"NATURAL":{"speed":1.0,"instructions":"Voice: Warm and grounded audiobook narration. Delivery: Natural pace, attentive phrasing, and calm confidence."},"BRISK":{"speed":1.12,"instructions":"Brisk, warm and grounded audiobook narration."}}', 'eu', 'eu-private-v1', 'folio-preview-v1', 'speech-eval-2026-08', 'CURRENT'),
    ('30000000-0000-7000-8000-000000000002', '10000000-0000-7000-8000-000000000002', '20000000-0000-7000-8000-000000000001', 'marlowe-openai-v1', 'marin',
     '{"MEASURED":{"speed":0.88,"instructions":"Measured, clear and assured audiobook narration."},"NATURAL":{"speed":1.0,"instructions":"Voice: Clear and assured audiobook narration. Delivery: Natural pace, precise phrasing, and composed confidence."},"BRISK":{"speed":1.12,"instructions":"Brisk, clear and assured audiobook narration."}}', 'eu', 'eu-private-v1', 'folio-preview-v1', 'speech-eval-2026-08', 'CURRENT'),
    ('30000000-0000-7000-8000-000000000003', '10000000-0000-7000-8000-000000000003', '20000000-0000-7000-8000-000000000001', 'ellis-openai-v1', 'coral',
     '{"MEASURED":{"speed":0.88,"instructions":"Measured, bright and expressive audiobook narration."},"NATURAL":{"speed":1.0,"instructions":"Voice: Bright and expressive audiobook narration. Delivery: Natural pace, lively phrasing, and emotionally attentive restraint."},"BRISK":{"speed":1.12,"instructions":"Brisk, bright and expressive audiobook narration."}}', 'eu', 'eu-private-v1', 'folio-preview-v1', 'speech-eval-2026-08', 'CURRENT'),
    ('30000000-0000-7000-8000-000000000004', '10000000-0000-7000-8000-000000000004', '20000000-0000-7000-8000-000000000001', 'callum-openai-v1', 'ballad',
     '{"MEASURED":{"speed":0.88,"instructions":"Measured, calm and intimate audiobook narration."},"NATURAL":{"speed":1.0,"instructions":"Voice: Calm and intimate audiobook narration. Delivery: Natural pace, gentle phrasing, and close, reassuring presence."},"BRISK":{"speed":1.12,"instructions":"Brisk, calm and intimate audiobook narration."}}', 'eu', 'eu-private-v1', 'folio-preview-v1', 'speech-eval-2026-08', 'CURRENT'),
    ('30000000-0000-7000-8000-000000000005', '10000000-0000-7000-8000-000000000005', '20000000-0000-7000-8000-000000000001', 'ansel-openai-v1', 'ash',
     '{"MEASURED":{"speed":0.88,"instructions":"Measured, open and conversational audiobook narration."},"NATURAL":{"speed":1.0,"instructions":"Voice: Open and conversational audiobook narration. Delivery: Natural pace, easy phrasing, and an inviting, unforced presence."},"BRISK":{"speed":1.12,"instructions":"Brisk, open and conversational audiobook narration."}}', 'eu', 'eu-private-v1', 'folio-preview-v1', 'speech-eval-2026-08', 'CURRENT'),
    ('30000000-0000-7000-8000-000000000006', '10000000-0000-7000-8000-000000000006', '20000000-0000-7000-8000-000000000001', 'sloane-openai-v1', 'sage',
     '{"MEASURED":{"speed":0.88,"instructions":"Measured, poised and reflective audiobook narration."},"NATURAL":{"speed":1.0,"instructions":"Voice: Poised and reflective audiobook narration. Delivery: Natural pace, thoughtful phrasing, and quiet emotional depth."},"BRISK":{"speed":1.12,"instructions":"Brisk, poised and reflective audiobook narration."}}', 'eu', 'eu-private-v1', 'folio-preview-v1', 'speech-eval-2026-08', 'CURRENT');
