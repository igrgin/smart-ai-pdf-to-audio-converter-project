package dev.audiobook.platform.generation.speech.segmentation.service;
...
class SpeechSegmentationServiceTest {
    ...
    void sameApprovedPlanAndRecipeProduceTheSameGaplessManifestAndOperationKeys() {
        List<SpeechSegmentationService.ApprovedChapter> chapters =
                List.of(
                        new SpeechSegmentationService.ApprovedChapter(
                                ...
                                List.of(
                                        new SpeechSegmentationService.SpokenUnit(
                                                "one two three four", SpeechBoundaryKind.PARAGRAPH),
                                        new SpeechSegmentationService.SpokenUnit(
                                                "five six", SpeechBoundaryKind.CHAPTER))),
                        new SpeechSegmentationService.ApprovedChapter(
                                1,
                                "Closing",
                                List.of(
                                        new SpeechSegmentationService.SpokenUnit(
                                                "seven", SpeechBoundaryKind.CHAPTER))));

        SpeechSegmentationService.Manifest first =
                service.segment(
                        new SpeechSegmentationService.SegmentationRequest(
                                CONVERSION_ID, RECIPE_DIGEST, "plan-v1", 10, chapters));
        SpeechSegmentationService.Manifest replay =
                service.segment(
                        new SpeechSegmentationService.SegmentationRequest(
                                CONVERSION_ID, RECIPE_DIGEST, "plan-v1", 10, chapters));
        ...
        assertThat(first.segments())
                ...
                .containsExactly(
                        org.assertj.core.groups.Tuple.tuple(
                                0, 0, "one two", SpeechBoundaryKind.LIMIT_CONTINUATION),
                        org.assertj.core.groups.Tuple.tuple(
                                0, 1, "three four", SpeechBoundaryKind.PARAGRAPH),
                        org.assertj.core.groups.Tuple.tuple(
                                0, 2, "five six", SpeechBoundaryKind.CHAPTER),
                        org.assertj.core.groups.Tuple.tuple(
                                1, 0, "seven", SpeechBoundaryKind.CHAPTER));
        assertThat(first.segments())
