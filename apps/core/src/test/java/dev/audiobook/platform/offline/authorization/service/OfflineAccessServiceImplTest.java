    ...
    void normalizesAuthorizationTimesBeforeSigningAndReturningThem() {
        ...
        var command =
                new OfflineAccessService.IssueAuthorization(
                        ...
                        "operation-1");
        var playback =
                new PrivateAudiobookLibraryService.PlaybackManifest(
                        command.audiobookId(),
        ...
        given(jdbcTemplate.query(anyString(), any(RowMapper.class), any(Object[].class)))
                .willReturn(List.of());
        given(jdbcTemplate.queryForObject(anyString(), eq(Long.class), any(Object[].class)))
                .willReturn(1L);
        ...
        assertThat(authorization.authorization().claims().expiresAt())
                .isEqualTo(databaseTime.plus(Duration.ofDays(30)));
