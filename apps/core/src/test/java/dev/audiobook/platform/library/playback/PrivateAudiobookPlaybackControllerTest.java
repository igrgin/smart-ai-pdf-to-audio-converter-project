...
class PrivateAudiobookPlaybackControllerTest {
    ...
    private static final UUID AUDIOBOOK_ID =
            UUID.fromString("01985f42-5f8d-7000-8000-000000000132");
    private static final UUID ASSET_VERSION_ID =
            UUID.fromString("01985f42-5f8d-7000-8000-000000000232");
    ...
    @MockitoBean private PrivateAudiobookLibraryService libraryService;
        ...
        when(libraryService.manifest(LISTENER_ID, AUDIOBOOK_ID, ASSET_VERSION_ID))
                .thenReturn(
                        new PrivateAudiobookLibraryService.PlaybackManifest(
                                ...
                                List.of(
                                        new PrivateAudiobookLibraryService.PlaybackChapter(
                                                CHAPTER_ID,
                                                0,
                                                "First light",
                                                0,
    ...
    void mediaMapsOneVerifiedRangeAndAnUnsatisfiedRangeToHttpSemantics() throws Exception {
        ...
        when(libraryService.media(
                        ...
                        false))
                .thenReturn(
                        new PrivateAudiobookLibraryService.MediaResponse(
                                "audio/mpeg",
                                "sha256:" + digest,
                                10,
                                2L,
