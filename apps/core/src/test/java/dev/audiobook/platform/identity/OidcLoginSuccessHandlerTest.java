...
class OidcLoginSuccessHandlerTest {
    ...
    @Test
    void ordinaryListenerDoesNotReceiveOperatorAuthorityAfterBrokerAuthentication() throws Exception {
    ...
    private Authentication authenticate(
        ...
        ExternalIdentity externalIdentity = new ExternalIdentity(
                ...
                "Operator");
        when(identityService.establish(any())).thenReturn(new ListenerSession(
                OPERATOR_ID,
                "Operator",
                "operator@example.test",
