...
class NarrationControllerTest {
    ...
    private static final UUID CONVERSION_ID =
            UUID.fromString("01985f42-5f8d-7000-8000-000000000128");
    ...
    void listenerComparesAProviderNeutralCatalogWithOneStandardPreviewPassage() throws Exception {
        when(narrationSelectionService.catalog())
                .thenReturn(
                        new NarrationSelectionService.VoiceCatalog(
                                List.of(
                                        voice(
                                                VOICE_ID,
                                                "Rowan",
        ...
        mockMvc.perform(
                ...
                .andExpect(
                        jsonPath("$.voices[0].descriptorReviewVersion")
                                .value("voice-review-2026-07"))
    ...
    @Test
    void listenerConfirmsAnIssuedVoiceAndExactPaceAgainstTheSeenConversionVersion()
            throws Exception {
        UUID recipeId = UUID.fromString("01985f42-5f8d-7000-8000-000000000228");
        when(narrationSelectionService.confirm(
                ...
                .thenReturn(
                        new NarrationSelectionService.ConfirmedRecipe(
                                recipeId,
                                CONVERSION_ID,
                                VOICE_ID,
                                "Rowan",
        ...
        verify(narrationSelectionService)
                .confirm(
                        new NarrationSelectionService.ConfirmCommand(
                                LISTENER_ID,
                                CONVERSION_ID,
