...
import dev.audiobook.platform.entitlement.ledger.EntitlementPolicyProperties;
...
class ConversionEntitlementServiceTest {
    ...
    private final ConversionEntitlementService service =
            new ConversionEntitlementServiceImpl(
                    jdbcTemplate,
    ...
    void rejectsInvalidGrantReferencesBeforePersistence() {
        ...
        assertThatThrownBy(
                        () ->
                                service.approveFreeGrant(
                                        listenerId, "x".repeat(201), "grant-operation"))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("approvalReference");
