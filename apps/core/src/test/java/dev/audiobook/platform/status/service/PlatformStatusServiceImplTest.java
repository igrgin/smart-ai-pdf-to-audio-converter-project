package dev.audiobook.platform.status.service;
...
import dev.audiobook.platform.status.PlatformStatus;
...
class PlatformStatusServiceImplTest {
    ...
    void databaseFailureIsReportedWithoutFailingThePublicStatus() {
        ...
        given(
                ...
                .willThrow(
                        new DataAccessResourceFailureException(
                                "connection details must stay private"));
        PlatformStatusService service =
                new PlatformStatusServiceImpl(
                        jdbcTemplate, new PlatformBuildProperties("0.1.0", "a1b2c3d"));
        ...
        assertThat(status.availability().database())
