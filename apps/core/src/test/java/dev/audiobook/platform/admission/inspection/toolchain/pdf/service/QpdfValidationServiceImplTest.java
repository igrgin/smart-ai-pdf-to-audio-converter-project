...
class QpdfValidationServiceImplTest {
    ...
    private QpdfValidationService.Result validate(
            InspectionCommandRunner.Result... commandResults) {
        ...
        return new QpdfValidationServiceImpl(properties(), runner)
                .validate(scratch.resolve("opaque"));
    }
