...
function App() {
  ...
  const online =
    platformStatus?.availability.core === "AVAILABLE" &&
    platformStatus.availability.database === "AVAILABLE";
    ...
    <div className="app-shell">
      <header className="site-header">
        ...
        <nav aria-label="Primary navigation">
          ...
          <Button variant="ghost" size="icon" onClick={() => setTheme(theme === "light" ? "dark" : "light")} aria-label={`Switch to ${theme === "light" ? "dark" : "light"} mode`}>
      ...
      <main id="top">
          ...
          <article className="sample-card" id="sample" aria-labelledby="sample-title">
            ...
            <div className="player">
              <div className="player-heading">
                ...
                <Button size="icon" onClick={toggleSample} aria-label={`${isPlaying ? "Pause" : "Play"} public sample`}>
              ...
              <audio ref={audioRef} src="/samples/midnight-library-of-small-beginnings.mp3" onEnded={() => setIsPlaying(false)} preload="metadata" />
        ...
        <section className="platform-strip" aria-label="Platform availability">
          ...
          <div>
            ...
            <span>
              {platformStatus
                ? `Build ${platformStatus.build.version} · ${platformStatus.build.revision}`
                : "Content-free availability from the same-origin core"}
            </span>
          </div>
